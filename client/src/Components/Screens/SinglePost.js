    ...
    <div key={post._id} className="single-post-container card home-card">
      <h5 className="posted-by">
        ...
        >
          {" "}
          <span>
            {post.postedBy._id === state._id ? "You" : post.postedBy.name}
          </span>
        </Link>
        {post.postedBy._id === state._id && (
          <span>
            <i
              className="unlike material-icons"
      ...
      <div className="card-content">
        <div className="post-info-stripe">
          ...
          <span className="post-date">{relativeDate(post.createdAt)}</span>
        </div>
            ...
            {post.comments.map((comment, index) => {
              return (
                <>
                  <h6 key={index}>
                    <span
                      className={comment.postedBy._id === state._id ? "Me" : ""}
                    >
